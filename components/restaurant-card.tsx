      ...
      <div className="flex flex-col gap-3 p-4">
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex shrink-0 flex-col items-end gap-1">
            ...
            {r.open ? <CrowdMeter level={r.crowd} /> : <span className="h-1.5 w-20 rounded-full bg-muted" />}
          </div>
        </div>
        ...
        <div className="flex items-center justify-between border-t border-border/60 pt-2.5">
          ...
          <div className="flex items-center gap-2">
            <button
              type="button"
              className="inline-flex items-center gap-1 rounded-full bg-primary px-2.5 py-1.5 text-xs font-semibold text-primary-foreground transition-transform active:scale-95"
            >
